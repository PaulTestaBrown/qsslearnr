...
Congrats on getting through this tutorial! Please upload this html file to [Canvas](https://canvas.brown.edu/courses/1094972/assignments). 
...
knitr::kable(params$output[, c("id", "attempted")])
```
